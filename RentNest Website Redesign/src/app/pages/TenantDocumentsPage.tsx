...
import { useTenantDocumentsQuery } from "@/features/tenant/hooks/useTenantData";

export const TenantDocumentsPage: React.FC = () => {
  const { data: docs } = useTenantDocumentsQuery();
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Lease agreements, identity verification, move-in checklists, and utility statements.
          </p>
        </div>
